...
## Buttons
#set_property -dict { PACKAGE_PIN B22 IOSTANDARD LVCMOS12 } [get_ports { btnc_i }]; #IO_L20N_T3_16 Sch=btnc
set_property -dict { PACKAGE_PIN D22 IOSTANDARD LVCMOS12 } [get_ports { btnd_i }]; #IO_L22N_T3_16 Sch=btnd
#set_property -dict { PACKAGE_PIN C22 IOSTANDARD LVCMOS12 } [get_ports { btnl_i }]; #IO_L20P_T3_16 Sch=btnl
#set_property -dict { PACKAGE_PIN D14 IOSTANDARD LVCMOS12 } [get_ports { btnr_i }]; #IO_L6P_T0_16 Sch=btnr
set_property -dict { PACKAGE_PIN F15 IOSTANDARD LVCMOS12 } [get_ports { btnu_i }]; #IO_0_16 Sch=btnu
set_property -dict { PACKAGE_PIN G4  IOSTANDARD LVCMOS15 } [get_ports { rst_n_i }]; #IO_L12N_T1_MRCC_35 Sch=cpu_resetn


## Switches
set_property -dict { PACKAGE_PIN E22  IOSTANDARD LVCMOS12 } [get_ports { sw_i }]; #IO_L22P_T3_16 Sch=sw[0]
#set_property -dict { PACKAGE_PIN F21  IOSTANDARD LVCMOS12 } [get_ports { sw_i[1] }]; #IO_25_16 Sch=sw[1]
#set_property -dict { PACKAGE_PIN G21  IOSTANDARD LVCMOS12 } [get_ports { sw_i[2] }]; #IO_L24P_T3_16 Sch=sw[2]
#set_property -dict { PACKAGE_PIN G22  IOSTANDARD LVCMOS12 } [get_ports { sw_i[3] }]; #IO_L24N_T3_16 Sch=sw[3]
#set_property -dict { PACKAGE_PIN H17  IOSTANDARD LVCMOS12 } [get_ports { sw_i[4] }]; #IO_L6P_T0_15 Sch=sw[4]
#set_property -dict { PACKAGE_PIN J16  IOSTANDARD LVCMOS12 } [get_ports { sw_i[5] }]; #IO_0_15 Sch=sw[5]
#set_property -dict { PACKAGE_PIN K13  IOSTANDARD LVCMOS12 } [get_ports { sw_i[6] }]; #IO_L19P_T3_A22_15 Sch=sw[6]
#set_property -dict { PACKAGE_PIN M17  IOSTANDARD LVCMOS12 } [get_ports { sw_i[7] }]; #IO_25_15 Sch=sw[7]


## OLED Display
set_property -dict { PACKAGE_PIN W22   IOSTANDARD LVCMOS33 } [get_ports { oled_dc_n_o }]; #IO_L7N_T1_D10_14 Sch=oled_dc
set_property -dict { PACKAGE_PIN U21   IOSTANDARD LVCMOS33 } [get_ports { oled_res_n_o }]; #IO_L4N_T0_D05_14 Sch=oled_res
set_property -dict { PACKAGE_PIN W21   IOSTANDARD LVCMOS33 } [get_ports { oled_sclk_o }]; #IO_L7P_T1_D09_14 Sch=oled_sclk
set_property -dict { PACKAGE_PIN Y22   IOSTANDARD LVCMOS33 } [get_ports { oled_sdo_o }]; #IO_L9N_T1_DQS_D13_14 Sch=oled_sdin
set_property -dict { PACKAGE_PIN P20   IOSTANDARD LVCMOS33 } [get_ports { oled_vbat_n_o }]; #IO_0_14 Sch=oled_vbat
set_property -dict { PACKAGE_PIN V22   IOSTANDARD LVCMOS33 } [get_ports { oled_vdd_n_o }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=oled_vdd
...
## Audio Codec
set_property -dict { PACKAGE_PIN T4    IOSTANDARD LVCMOS33 } [get_ports { codec_adc_sdata_i }]; #IO_L13N_T2_MRCC_34 Sch=codec_adc_sdata_i
set_property -dict { PACKAGE_PIN T5    IOSTANDARD LVCMOS33 } [get_ports {codec_bclk_i }]; #IO_L14P_T2_SRCC_34 Sch=ac_bclk_i
set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 } [get_ports {codec_dac_sdata_o }]; #IO_L15P_T2_DQS_34 Sch=ac_dac_sdata_o
set_property -dict { PACKAGE_PIN U5    IOSTANDARD LVCMOS33 } [get_ports {codec_lrclk_i }]; #IO_L14N_T2_SRCC_34 Sch=ac_lrclk_i
set_property -dict { PACKAGE_PIN U6    IOSTANDARD LVCMOS33 } [get_ports {codec_mclk_o }]; #IO_L16P_T2_34 Sch=ac_mclk_o
...
## I2C
set_property -dict { PACKAGE_PIN W5    IOSTANDARD LVCMOS33 } [get_ports { codec_scl_io }]; #IO_L15N_T2_DQS_34 Sch=codec_scl_io
set_property -dict { PACKAGE_PIN V5    IOSTANDARD LVCMOS33 } [get_ports { codec_sda_io }]; #IO_L16N_T2_34 Sch=codec_sda_io
